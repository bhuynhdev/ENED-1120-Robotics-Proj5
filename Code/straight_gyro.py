...
def main():
    ...
    forward_with_time(steer_pair, gyro_sensor, time_sec=9) # Forward 10 sec
    sleep(2)
    backward_with_time(steer_pair, gyro_sensor, time_sec=1.215) # Backward 4.3s 
    sleep(2)  
    forward_with_time(steer_pair, gyro_sensor, time_sec=3) # Forward 5 sec
    sleep(2)
    backward_with_time(steer_pair, gyro_sensor, time_sec=10) # Backward 9s 
    sleep(2)       
